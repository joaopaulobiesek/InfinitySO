        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LowQuantity = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Patrimony", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Patrimony_Category_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Category",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Patrimony_SubCategory_SubCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Liter = table.Column<double>(nullable: false),
                    KG = table.Column<double>(nullable: false),
                    Amount = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatrimonyKey", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PatrimonyKey_Patrimony_PatrimonyId",
                        column: x => x.PatrimonyId,
                        principalTable: "Patrimony",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PatrimonyKey_Sector_SectorId",
                        column: x => x.SectorId,
                        principalTable: "Sector",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatrimonyKeyId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatrimonyKeyDescription", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PatrimonyKeyDescription_PatrimonyKey_PatrimonyKeyId",
                        column: x => x.PatrimonyKeyId,
                        principalTable: "PatrimonyKey",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patrimony_CategoryId",
                table: "Patrimony",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Patrimony_SubCategoryId",
                table: "Patrimony",
                column: "SubCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_PatrimonyKey_PatrimonyId",
                table: "PatrimonyKey",
                column: "PatrimonyId");

            migrationBuilder.CreateIndex(
                name: "IX_PatrimonyKey_SectorId",
                table: "PatrimonyKey",
                column: "SectorId");

            migrationBuilder.CreateIndex(
                name: "IX_PatrimonyKeyDescription_PatrimonyKeyId",
                table: "PatrimonyKeyDescription",
                column: "PatrimonyKeyId");
