...
namespace InfinitySO.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            await _userManager.AddClaimAsync(app, new Claim("SubCategory", "5"));
            await _userManager.AddClaimAsync(app, new Claim("PatrimonyKey", "5"));
            await _userManager.AddClaimAsync(app, new Claim("PatrimonyKeyDescription", "5"));
            ...
            await _userManager.AddClaimAsync(app, new Claim("SubCategoryCreate", "5"));
            await _userManager.AddClaimAsync(app, new Claim("SubCategoryEdit", "5"));
            await _userManager.AddClaimAsync(app, new Claim("SubCategoryDelete", "5"));
            await _userManager.AddClaimAsync(app, new Claim("PatrimonyKeyCreate", "5"));
            await _userManager.AddClaimAsync(app, new Claim("PatrimonyKeyEdit", "5"));
            await _userManager.AddClaimAsync(app, new Claim("PatrimonyKeyDelete", "5"));
            await _userManager.AddClaimAsync(app, new Claim("PatrimonyKeyDescriptionCreate", "5"));
            await _userManager.AddClaimAsync(app, new Claim("PatrimonyKeyDescriptionEdit", "5"));
            await _userManager.AddClaimAsync(app, new Claim("PatrimonyKeyDescriptionDelete", "5"));
